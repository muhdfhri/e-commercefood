...
class ProductReviewController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','Terima kasih telah memberikan ulasan');
        }
        else{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($review){
            ...
            // Notification::send($user,new StatusNotification($details));
            if($status){
                request()->session()->flash('success','Review berhasil diperbarui');
            }
            else{
                request()->session()->flash('error','Terjadi kesalahan! Silahkan coba lagi!!');
            }
    ...
    public function destroy($id)
    {
        ...
        if($status){
            request()->session()->flash('success','Review berhasil dihapus');
        }
        else{
            request()->session()->flash('error','Terjadi kesalahan! Silahkan coba lagi!!');
        }
