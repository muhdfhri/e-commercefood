							...
							@if(Helper::getAllProductFromWishlist())
								@foreach(Helper::getAllProductFromWishlist() as $key=>$wishlist)
									<tr>
										...
										<td class="total-amount text-right" data-title="Total"><span>Rp {{ number_format($wishlist['amount'], 0, ',', '.') }}</span></td>
										<td class="text-center"><a href="{{route('add-to-cart',$wishlist->product['slug'])}}" class='btn text-white'>Tambah Ke Keranjang</a></td>
