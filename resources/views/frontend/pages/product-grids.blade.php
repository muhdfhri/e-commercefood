                                            ...
                                            <div class="content">
                                                ...
                                                <p class="price">
                                                    @if($product->discount > 0)
                                                        ...
                                                        <span class="ml-2">Rp{{ number_format($org, 0, ',', '.') }}</span>
                                                    @else
                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="button-head">
                                                    <div class="product-action">
                                                        <a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" class="wishlist" data-id="{{$product->id}}"><i class=" ti-heart "></i><span>Tambahkan Wishlist</span></a>
                                                    </div>
