        ...
        <div class="form-group">
          ...
          <div class="form-group">
              ...
              <select name="type" class="form-control">
                  <option value="fixed" {{(($coupon->type=='fixed') ? 'selected' : '')}}>Potongan Harga (Fixed)</option>
                  <option value="percent" {{(($coupon->type=='percent') ? 'selected' : '')}}>Persentase (Percent)</option>
              </select>
              @error('type')
              <span class="text-danger">{{$message}}</span>
              @enderror
          ...
          <div class="form-group">
              ...
              <input id="inputTitle" type="number" name="value" placeholder="Masukkan Nilai"  value="{{$coupon->value}}" class="form-control">
              @error('value')
              <span class="text-danger">{{$message}}</span>
              @enderror
          </div>
