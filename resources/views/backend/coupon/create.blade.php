      ...
      <form method="post" action="{{route('coupon.store')}}">
        ...
        <div class="form-group">
            ...
            <select name="type" class="form-control">
                <option value="fixed">Potongan Harga (Fixed)</option>
                <option value="percent">Persentase (Percent)</option>
            </select>
            @error('type')
            <span class="text-danger">{{$message}}</span>
            @enderror
        ...
        <div class="form-group">
            ...
            <input id="inputTitle" type="number" name="value" placeholder="Masukkan Nilai"  value="{{old('value')}}" class="form-control">
            @error('value')
            <span class="text-danger">{{$message}}</span>
            @enderror
        </div>
