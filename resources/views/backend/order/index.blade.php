 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive">
          ...
          <tbody>
            ...
            @endphp 
                <tr>
                    ...
                    <td>
                        <a href="{{route('order.show',$order->id)}}" class="btn btn-warning btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="Lihat" data-placement="bottom"><i class="fas fa-eye"></i></a>
        ...
        @else
          <h6 class="text-center">Tidak ada pesanan!!! Silahkan pesan produk</h6>
        @endif
      </div>
    </div>
</div>
